...
# Pre-buffer retention must exceed CAPTURE_PRE_SEC (20s) + trigger jitter margin.
CAMERA_BUFFER_MAX_AGE_SEC = 30.0
PRE_BUFFER_RETENTION_SEC = CAMERA_BUFFER_MAX_AGE_SEC
CAPTURE_PRE_SEC = 20.0
CAPTURE_POST_SEC = 20.0
MIN_DISK_FREE_MB = 5120
# RAM safety: allow up to ASSUMED_MAX_FPS * 30s frames; time eviction is authoritative.
CAMERA_BUFFER_ASSUMED_MAX_FPS = 8.0
MAX_CAMERA_FRAMES_PER_CAM = max(
    90,
    int(CAMERA_BUFFER_ASSUMED_MAX_FPS * CAMERA_BUFFER_MAX_AGE_SEC + 0.5),
)
