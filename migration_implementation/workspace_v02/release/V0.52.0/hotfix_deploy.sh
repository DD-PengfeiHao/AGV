...
SRC="/tmp/v052_deploy/dw/dashboard_node.py"

docker cp "$SRC" "$C:/opt/delivery_ws/src/delivery_web/delivery_web/dashboard_node.py"
docker cp "$SRC" "$C:/opt/delivery_ws/install/delivery_web/lib/python3.10/site-packages/delivery_web/dashboard_node.py"
